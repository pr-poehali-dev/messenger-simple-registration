  ...
  return (
    <div className="flex flex-col h-full bg-background">
      ...
      <div className="flex-1 p-5 space-y-4">
        <div className="bg-white border border-border rounded-2xl p-6 flex flex-col items-center gap-4 animate-scale-in">
          <div className="w-20 h-20 rounded-full bg-foreground text-primary-foreground flex items-center justify-center text-3xl font-semibold">
            {initials}
          </div>
        ...
        <div className="bg-white border border-border rounded-2xl overflow-hidden animate-fade-in">
          <div className="px-5 py-4 border-b border-border flex items-center gap-3">
            ...
            <div>
              <p className="text-xs text-muted-foreground">Ник</p>
