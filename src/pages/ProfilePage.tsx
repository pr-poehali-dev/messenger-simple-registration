  ...
  return (
    <div className="flex flex-col h-full bg-background">
      <div className="bg-white border-b border-border px-5 py-5">
        <h2 className="font-semibold text-base text-[#000000]">Профиль</h2>
      </div>

      <div className="flex-1 p-5 space-y-4 bg-[#ffffff]">
        <div className="border border-border rounded-2xl p-6 flex flex-col items-center gap-4 animate-scale-in bg-slate-400">
        ...
        <div className="bg-white border border-border rounded-2xl overflow-hidden animate-fade-in">
          <div className="px-5 py-4 border-b border-border flex items-center gap-3 bg-slate-400">
          ...
          <div className="px-5 py-4 flex items-center gap-3 bg-slate-400">
        ...
        <div className="bg-white border border-border rounded-2xl overflow-hidden animate-fade-in" style={{ animationDelay: "0.05s" }}>
          <button
            onClick={logout}
            className="w-full px-5 py-4 flex items-center gap-3 text-destructive hover:bg-destructive/5 transition-colors bg-slate-400"
          >
